# LinkedIn Profile Search and Data Collection Application
...
- Secure login with LinkedIn account
- Profile search based on keywords
- Automatic data collection and export to Excel
- Dark/Light theme support
- Save and reuse session information
...
3. Install the required libraries:
   ...
   ```
4. Install Firefox browser and Firefox WebDriver:
   - Download and install the Firefox browser and geckodriver.
